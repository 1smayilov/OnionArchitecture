...
public class FileLogger:LoggerServiceBase
{
    ...
    public FileLogger(IConfiguration configuration)
    {
        ...
        Logger = new LoggerConfiguration().WriteTo.File(
            logFilePath, rollingInterval: RollingInterval.Day, // Hər gün yeni bir file yarat
            fileSizeLimitBytes: 5000000, // File ın ölçü limiti 
            retainedFileCountLimit: null, // File ölçü limitinə çatanda silsin? 
