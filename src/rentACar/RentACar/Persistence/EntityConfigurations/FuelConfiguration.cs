...
namespace Persistence.EntityConfigurations
{
    public class FuelConfiguration : IEntityTypeConfiguration<Fuel>
    {
        ...
        {
            builder.ToTable("Fuels").HasKey(f => f.Id); // Hansı table - a qarşılıqdır
            ...
            builder.HasMany(f => f.Models); // Bir Fuelsin 1 dən çox modeli ola bilər

            builder.HasQueryFilter(f => !f.DeletedDate.HasValue); // SoftDelete
        }
    }
}
